...
//     });
//         await pool.connect()
//         //const res = await pool.query(getMetaRating2)
//         const { rows } = await pool.query(getMetaRating)
//         console.log(rows);
//         //console.log(rows[0]['rating']['1'])
//         // console.log(JSON.stringify(res.rows))
//         // console.log(res.fields)
//         // let data = JSON.stringify(res.rows)
//         // data = JSON.parse(res.rows)
//         let ratingsData = `{'product_id': ${review_id}
//                           'ratings': {
//                             '1': ${rows[0]['rating']['1']},
//                             '2': ${rows[1]['rating']['2']},
//                             '3': ${rows[2]['rating']['3']},
...
//         await pool.end()
//     } catch (error) {
//         console.log(error, 'Error from db connection in controllers.js')
//     }
// };
